...
<?php
  ...
  $sql = "SELECT compte.PrenomUser , compte.NomUser 
   FROM compte 
   WHERE compte.IdCompte = $idcompte_patient;"
    ;
  $sql2 = "SELECT ant.maladie,ant.typ
   FROM `ant` 
   WHERE ant.idCompte=$idcompte_patient ;"
    ;
    try{
  ...
  if(isset($_POST['ajouter']))
    {
        ...
        $idcompt=4;
        $insertion=$bdd->prepare('INSERT INTO ant(maladie,typ,idCompte)
                 VALUES(?,?,?)');
   
    $insertion->execute(array($Maladie,$Typ,filter_var($idcompte_patient, FILTER_SANITIZE_NUMBER_INT)));
    header("Location: ./Antecedents.php?id=$idcompte_patient");
    }
...
<body class="animsition">
    <div class="page-wrapper">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="col-lg-12">
                               ...
                               <h2 class="title-1 m-b-25">Antécédents médicaux de  
                                   <?php echo $row["NomUser"] ?> <?php echo $row["PrenomUser"] ?>
                              </h2>
       ...
       <td><?php echo htmlspecialchars($row2['maladie']); ?></td>                                   
       <td><?php echo htmlspecialchars($row2['typ']); ?></td>                                  
     </tr>
     ...
     <?php endwhile; ?>
                            ...
                            <h2 class="title-1 m-b-25">Ajouter un antécédent médical</h2>
            ...
            <div class="row form-group">
                <div class="col col-md-12">
                   <div class="input-group">
                        <input type="text" id="maladie" name="maladie" placeholder="Maladie" class="form-control">
                    </div>
                </div>
            </div>
           <div class="row form-group ">
               <div class="col col-md-12">
                   <select placeholder="Personnel" class=" form-control" name="typ" id="typ" required>
                           <option value="Personnel" selected >Personnel</option>
                           <option value="Familial">Familial</option>
                           <option value="Familial et Personnel">Familial et Personnel</option>
                   </select>                            
                </div>
           </div>
