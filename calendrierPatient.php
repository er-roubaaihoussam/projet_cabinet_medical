...
<body class="animsition">
    <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="active has-sub">
                            <a class="js-arrow" href="./accueilPatient.php">
                                <i class="fas fa-desktop"></i>Dashboard</a>
                        </li>
                        
                        <li>
                            
                            <a href="./calendrierPatient.php?annee=<?=$annee?>&mois=<?=$mois?>&jour=<?=$jour?>">
        ...
        <div class="page-container">
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="./assetsDashboard/images/icon/patient1.jpg" alt="" />
                                        </div>
                                        <div class="content">
         ...
         <a class="text-secondary" href="./calendrierPatient.php?annee=<?=$anneeAvant?>&mois=<?=$moisAvant?>&jour=<?=$jourAvant?>">
           <i class="fas fa-caret-square-left align-self-end" id="avant"></i>
         </a>
         <div>
            <?php echo $jourLundi.$moisLundi."-".$jourDimanche.$moisDimanche;?>
         </div>
         <a class="text-secondary" href="./calendrierPatient.php?annee=<?=$anneeApres?>&mois=<?=$moisApres?>&jour=<?=$jourApres?>">
                              ...
                              foreach($tabRv as $rdv)
                              {
                                 ...
                                 if($rdv['DateRdv']==dateApresJours($lundi,$key)->format('Y-m-d')." ".$heure.":00")
                                 {
                                    ...
                                    if($rdv['IdCompte']==$id)
                                    {
                                        ...
                                        {
                                            echo'<td class="text-dark bg-secondary text-center">
                                            <a href="confirmation.php?statut=terminé&type=reserve&dateTime='.dateCible($key,$lundi,$heure).'" class="text-decoration-none text-light">terminé</a></td>';
                                        ...
                                        else
                                        {
                                           ...
                                           <a href="confirmation.php?payement=true&type=reserve&dateTime='.dateCible($key,$lundi,$heure).'" class="text-decoration-none text-light">réservé</a></td>';
                                                
                                            }
                                            else
                                            echo'<td  class="bg-info text-center">
                                           <a href="confirmation.php?type=reserve&dateTime='.dateCible($key,$lundi,$heure).'" class="text-decoration-none text-light">réservé</a></td>';
                                        }
                                    ...
                                    {
                                       echo'<td class="text-dark bg-danger text-center">réservé</td>';
                                    }
                                 ...
                                 if(dateCibleD($key,$lundi,$heure)>new DateTime("now")){
                                    ...
                                    <a href="confirmation.php?type=libre&dateTime='.dateCible($key,$lundi,$heure).'" class="text-decoration-none text-light">libre</a></td>';
                                 }else
                                 echo'<td ></td>';
