<?php
  ...
  ouvreSession();
   ...
   if(isset($_POST['confirmer']))
    ...
    VALUES(:dateRdv,:id)');
    $insertion->bindValue('dateRdv',$date);$insertion->bindValue('id',$id);
    $insertion->execute();
    header('Location: ./calendrierPatient.php?annee='.$annee.'&mois='.$mois.'&jour='.$jour);
    }
