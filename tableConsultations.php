...
<?php
  ...
  $sql = "SELECT compte.PrenomUser , compte.NomUser 
   ...
   WHERE compte.IdCompte = $idcompte_patient;"
    ;
  $sql2 = "SELECT consultation.dateConsultation,consultation.Conclusion,consultation.idConsultation
   FROM `consultation` 
   WHERE consultation.idCompte=$idcompte_patient ;"
    ;
    try{
...
<body class="animsition">
    <div class="page-wrapper">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="col-lg-12">
                               ...
                               <h2 class="title-1 m-b-25">Consultations de 
       ...
       <td><?php echo htmlspecialchars($row2['dateConsultation']); ?></td>                                   
       <td><?php echo htmlspecialchars($row2['Conclusion']); ?></td>
       <td>
        <button class="item" data-toggle="tooltip" title="Diagnostics de la consultation">
            <a href="./tableDiagnostics.php?id='<?php echo $row2['idConsultation'] ?>'">
