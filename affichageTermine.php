<?php
  ...
  $bdd=base_donnees();
   ...
   $dateAujourdhui=new DateTime("now");
    ...
    $sql = "UPDATE rdv SET rdvConfirme='true' WHERE idRdv=$idrdv";
    ...
    {
        $_SESSION["idSuivi"]=$_GET['id'];
        header('Location:./ProgrammeSuivie.php?annee='.$annee.'&mois='.$mois.'&jour='.$jour);
...
?>
              ...
              <?php if($type=='reserve'):?>
                ...
                <i class="far fa-window-close position-absolute" style="right: 12px;top:437px;"></i>
                    ...
                    <input type="submit" name="confirmer" value="confirmer et saisir la recette" class="btn btn-success position-absolute" style="left: 11px;width:210px">
                <i class="far fa-window-close position-absolute" style="right: 12px;top:437px;"></i>
              ...
              <?php endif;?>
              <?php else:?>
                <input type="submit" name="suivi" value="ajouter un programme de suivi" class="btn btn-primary position-absolute" style="right: 2px;width:232px">
